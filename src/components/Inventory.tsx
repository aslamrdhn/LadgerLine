    ...
    try {
      ...
      const endpoint =
        deleteConfirm.type === "product"
          ...
          : `/api/raw-materials/${deleteConfirm.id}`;
      ...
      <div className="mt-4">
        {activeSubTab === "products" && (
          <InventoryProducts
            ...
            onEdit={(p) =>
              triggerToast(`Edit produk belum diimplementasikan di versi ini.`)
            }
            onDelete={(id) => {
        ...
        {activeSubTab === "materials" && (
          <InventoryMaterials
            ...
            onEdit={(m) =>
              triggerToast(`Edit bahan belum diimplementasikan di versi ini.`)
            }
            onDelete={(id) => {
          ...
          <div className="bg-white p-6 rounded-2xl w-full max-w-sm border border-slate-100 shadow-2xl space-y-4">
            ...
            <div className="flex justify-end gap-2 pt-2 border-t border-slate-50">
              <button
                ...
                className="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-xs font-bold rounded-xl text-slate-700 transition-all cursor-pointer"
              >
                Batal
              </button>
              <button
