...
import { Palette, Sparkles, FileText, CheckCircle, LayoutGrid, Check } from 'lucide-react';
...
export function ThemeTab({ appConfig, onUpdateConfig }: ThemeTabProps) {
  ...
  const [currentTheme, setCurrentTheme] = useState<'slate' | 'espresso' | 'midnight' | 'matcha' | 'royal' | 'crimson' | 'ocean' | 'forest' | 'custom'>(appConfig.theme || 'slate');
  const [currentLayout, setCurrentLayout] = useState<'grid' | 'list'>(appConfig.layoutMode || 'grid');

  const handleUpdateThemeAndLayout = (themeName: 'slate' | 'espresso' | 'midnight' | 'matcha' | 'royal' | 'crimson' | 'ocean' | 'forest' | 'custom', layoutType: 'grid' | 'list') => {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3.5">
            ...
            >
              <div className="flex justify-between items-center mb-1.5">
                ...
                {currentTheme === 'slate' && <CheckCircle size={12} className="text-blue-500 animate-bounce" />}
              </div>
              ...
              <p className="text-[9.5px] text-slate-500 mt-2 font-medium">Enterprise Slate. Tema formal, tegas & profesional.</p>
            </div>
            ...
            >
              <div className="flex justify-between items-center mb-1.5">
                <span className="text-[10px] font-black uppercase text-amber-800 tracking-wider font-mono">Espresso Warm</span>
                {currentTheme === 'espresso' && <CheckCircle size={12} className="text-amber-700 animate-bounce" />}
              </div>
              ...
              <p className="text-[9.5px] text-slate-500 mt-2 font-medium">Espresso Baru. Kehangatan barista kayu kalsik.</p>
            </div>
            ...
            >
              <div className="flex justify-between items-center mb-1.5">
                ...
                {currentTheme === 'midnight' && <CheckCircle size={12} className="text-indigo-500 animate-bounce" />}
              </div>
              ...
              <p className="text-[9.5px] text-slate-500 mt-2 font-medium">Cyberpunk. Pelindung mata radiasi shift malam.</p>
            </div>
            ...
            >
              <div className="flex justify-between items-center mb-1.5">
                ...
                {currentTheme === 'matcha' && <CheckCircle size={12} className="text-emerald-600 animate-bounce" />}
              </div>
              ...
              <p className="text-[9.5px] text-slate-500 mt-2 font-medium">Kebun Matcha. Menyejukkan emosi antrean.</p>
            </div>
            ...
            >
              <div className="flex justify-between items-center mb-1.5">
                <span className="text-[10px] font-black uppercase text-purple-700 tracking-wider font-mono">Royal Premium</span>
                {currentTheme === 'royal' && <CheckCircle size={12} className="text-purple-600 animate-bounce" />}
              </div>
              ...
              <p className="text-[9.5px] text-slate-500 mt-2 font-medium">Lavender Royal. Sentuhan eksklusif & elegan.</p>
            </div>
            ...
            >
              <div className="flex justify-between items-center mb-1.5">
                <span className="text-[10px] font-black uppercase text-rose-850 tracking-wider font-mono">Crimson Velvet</span>
                {currentTheme === 'crimson' && <CheckCircle size={12} className="text-rose-600 animate-bounce" />}
              </div>
              ...
              <p className="text-[9.5px] text-slate-500 mt-2 font-medium">Velvet Cherry. Kopi artisan penuh gairah.</p>
            </div>
            ...
            >
              <div className="flex justify-between items-center mb-1.5">
                <span className="text-[10px] font-black uppercase text-sky-700 tracking-wider font-mono">Deep Ocean</span>
                {currentTheme === 'ocean' && <CheckCircle size={12} className="text-sky-600 animate-bounce" />}
              </div>
              ...
              <p className="text-[9.5px] text-slate-500 mt-2 font-medium">Lautan Ice Blue. Rileks, tenang & minimalis.</p>
            </div>
            ...
            >
              <div className="flex justify-between items-center mb-1.5">
                <span className="text-[10px] font-black uppercase text-emerald-850 tracking-wider font-mono">Cedar Forest</span>
                {currentTheme === 'forest' && <CheckCircle size={12} className="text-emerald-500 animate-bounce" />}
              </div>
              ...
              <p className="text-[9.5px] text-slate-500 mt-2 font-medium">Hutan Pine Wood. Bernuansa daun herbal natural.</p>
            </div>
            ...
            >
              <div className="flex justify-between items-center mb-1.5">
                ...
                {currentTheme === 'custom' && <CheckCircle size={12} className="text-violet-600 animate-bounce" />}
              </div>
              <div className="h-14 rounded-xl bg-gradient-to-tr from-violet-600 via-purple-700 to-indigo-800 p-1.5 flex flex-col justify-between border border-violet-500 shadow-sm">
                <div className="flex justify-end">
                  <span className="text-[7.5px] font-black text-white bg-black/45 px-1 py-0.2 rounded font-mono uppercase tracking-widest">KUSTOM</span>
                </div>
                <div className="w-8 h-2 rounded bg-white/20" />
              </div>
              <p className="text-[9.5px] text-slate-500 mt-2 font-bold text-violet-750">Desain Palette Warna Sendiri Sesuai Brand Cafe!</p>
            </div>
          ...
          {currentTheme === 'custom' && (
            <div className="p-5 rounded-2xl border border-violet-200 bg-gradient-to-r from-violet-50/15 via-white to-fuchsia-50/15 space-y-4 animate-fade-in shadow-xs">
              <div className="flex items-center gap-2 border-b border-purple-50 pb-2">
                <Sparkles size={15} className="text-violet-600 animate-pulse animate-spin" />
                <div>
                  <h4 className="text-xs font-black text-slate-800">Dynamic Custom Branding Engine (Branding Hub)</h4>
                  <p className="text-[10.5px] text-slate-500">Pilih palet warna kustom untuk brand cafe Anda. Penerapan akan langsung teraplikasi di seluruh halaman internal dan kasir.</p>
                </div>
              </div>

              {/* PALETTE PRESETS */}
              <div className="space-y-2">
                <p className="text-[10px] font-black uppercase text-violet-600 tracking-wider">Langkah Ringkas: Pilih Preset Palette Premium</p>
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-2">
                  <button
                    ...
                    onClick={() => {
                      onUpdateConfig({
                        ...
                        customThemeActiveTab: 'bg-pink-600/20 text-pink-400 border border-pink-500/20 font-extrabold shadow-sm',
                        customThemeInactiveTab: 'text-violet-300/50 hover:bg-white/5 hover:text-white',
                  ...
                  >
                    <div>
                      <p className="text-[10px] font-extrabold text-pink-600">🌆 Cyberpunk Neon</p>
                      <p className="text-[9px] text-slate-400 mt-0.5">Pink & Deep Purple (Art)</p>
                    </div>
                  ...
                  <button
                    ...
                    onClick={() => {
                      onUpdateConfig({
                        ...
                        customThemeActiveTab: 'bg-amber-500/20 text-amber-500 border border-amber-500/25 font-extrabold shadow-xs',
                        customThemeInactiveTab: 'text-neutral-400 hover:bg-white/5 hover:text-amber-100',
                      ...
                      triggerToast('Satu Klik: Tema Golden VIP Luxury Diterapkan!');
                    }}
                  ...
                  >
                    <div>
                      <p className="text-[10px] font-extrabold text-[#9A7F30]">👑 Golden VIP Lux</p>
                      <p className="text-[9px] text-slate-400 mt-0.5">Pure Charcoal & Gold Accent</p>
                    </div>
                  ...
                  <button
                    ...
                    onClick={() => {
                      onUpdateConfig({
                        ...
                        customThemeActiveTab: 'bg-rose-500/20 text-rose-500 border border-rose-500/25 font-bold shadow-xs',
                        customThemeInactiveTab: 'text-rose-200/55 hover:bg-white/5 hover:text-rose-100',
                      ...
                      triggerToast('Satu Klik: Tema Strawberry Bloom Diterapkan!');
                    }}
                  ...
                  >
                    <div>
                      <p className="text-[10px] font-extrabold text-rose-700">🍓 Strawberry Bloom</p>
                      <p className="text-[9px] text-slate-400 mt-0.5">Cute Pinkish Warm Bakery</p>
                    </div>
                  ...
                  <button
                    ...
                    onClick={() => {
                      onUpdateConfig({
                        ...
                        customThemeActiveTab: 'bg-[#FF8225]/20 text-[#FF8225] border border-[#FF8225]/25 font-extrabold shadow-xs',
                        customThemeInactiveTab: 'text-[#D0B195] hover:bg-white/5 hover:text-white',
                  ...
                  >
                    <div>
                      <p className="text-[10px] font-extrabold text-[#8D6E63]">🪵 Retro Woodcraft</p>
                      <p className="text-[9px] text-slate-400 mt-0.5">Classic Roasted Café Board</p>
                    </div>
