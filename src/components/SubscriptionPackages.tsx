  ...
  const packages = [
    {
      ...
      name: 'Basic POS',
      price: '500 Koin',
      features: ['Kasir POS Standard', 'Manajemen Stok Dasar', 'Laporan Harian', 'Akses 1 Kasir']
    },
    {
      id: 'pro',
      name: 'Pro Business',
      price: '1000 Koin',
      features: ['Semua Fitur Basic', 'Manajemen Resep', 'Inventory Lanjutan', 'Laporan Laba Rugi', 'Akses 3 Kasir'],
      isPopular: true
    },
    {
      id: 'enterprise',
      ...
      price: '1500 Koin',
      features: ['Semua Fitur Pro', 'Digital Auditor AI', 'Unlimited Kasir', 'API Access', 'Prioritas Support 24/7']
    }
  ];
    ...
    return (
      <div className="w-full h-full flex flex-col items-center justify-center bg-slate-50 p-6 animate-fade-in">
        <div className="bg-white p-8 rounded-3xl shadow-xl max-w-md w-full text-center border border-slate-100 relative overflow-hidden">
          ...
          <h2 className="text-2xl font-black text-slate-800 mb-2">Scan QRIS Midtrans</h2>
          <p className="text-sm text-slate-500 mb-8 px-4">
            Silakan scan QR Code di bawah ini menggunakan aplikasi e-wallet atau m-banking Anda untuk menyelesaikan pembayaran.
          </p>
          ...
          <div className="bg-white border-2 border-slate-200 p-4 rounded-2xl flex justify-center items-center mx-auto mb-6 w-64 h-64 shadow-inner">
             ...
             <img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=MIDTRANS_PAYMENT_DEMO_1500_KOIN" alt="QRIS" className="w-full h-full object-contain" />
          </div>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-500 max-w-2xl mx-auto">
            Tingkatkan kapasitas bisnis Anda dengan berlangganan paket Ladgerline. Pilih paket yang sesuai dengan kebutuhan sistem operasional Anda.
          </p>
        </div>
          ...
          {packages.map((pkg) => (
            ...
            >
              ...
              <div className="mb-6 pb-6 border-b border-slate-100">
                <h3 className="text-xl font-bold text-slate-800 mb-3">{pkg.name}</h3>
              ...
              >
                {selectedPackage === pkg.id ? 'Paket Terpilih' : 'Pilih Paket Ini'}
              </button>
            </div>
          ))}
        </div>
